...
func GetAllFreeAgentsWithOffers() []models.FreeAgentResponse {
	...
	for i, fa := range fas {
		...
		faResponseList[i] = models.FreeAgentResponse{
			...
			Age:               int8(fa.Age),
			Overall:           int8(fa.Overall),
			Height:            int8(fa.Height),
			Weight:            int8(fa.Weight),
			FootballIQ:        int8(fa.FootballIQ),
			Speed:             int8(fa.Speed),
			Carrying:          int8(fa.Carrying),
			Agility:           int8(fa.Agility),
			Catching:          int8(fa.Catching),
			RouteRunning:      int8(fa.RouteRunning),
			ZoneCoverage:      int8(fa.ZoneCoverage),
			ManCoverage:       int8(fa.ManCoverage),
			Strength:          int8(fa.Strength),
			Tackle:            int8(fa.Tackle),
			PassBlock:         int8(fa.PassBlock),
			RunBlock:          int8(fa.RunBlock),
			PassRush:          int8(fa.PassRush),
			RunDefense:        int8(fa.RunDefense),
			ThrowPower:        int8(fa.ThrowPower),
			ThrowAccuracy:     int8(fa.ThrowAccuracy),
			KickAccuracy:      int8(fa.KickAccuracy),
			KickPower:         int8(fa.KickPower),
			PuntAccuracy:      int8(fa.PuntAccuracy),
			PuntPower:         int8(fa.PuntPower),
			InjuryRating:      int8(fa.Injury),
			Stamina:           int8(fa.Stamina),
