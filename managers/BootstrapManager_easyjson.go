		...
		case "DraftScoutingProfileMap":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					...
					easyjson83226b63DecodeGithubComCalebRoseSimFBAModels2(in, &v286)
...
func easyjson83226b63EncodeGithubComCalebRoseSimFBAManagers13(out *jwriter.Writer, in BootstrapDataDraft) {
	...
	_ = first
	{
		...
		if in.NFLDraftees == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v287, v288 := range in.NFLDraftees {
				if v287 > 0 {
					out.RawByte(',')
				}
				easyjson83226b63EncodeGithubComCalebRoseSimFBAModels(out, v288)
			}
			out.RawByte(']')
		}
	}
	{
		...
		if in.NFLWarRoomMap == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v289First := true
			for v289Name, v289Value := range in.NFLWarRoomMap {
				if v289First {
					v289First = false
				} else {
					out.RawByte(',')
				}
				out.UintStr(uint(v289Name))
				out.RawByte(':')
				easyjson83226b63EncodeGithubComCalebRoseSimFBAModels1(out, v289Value)
			}
			out.RawByte('}')
		}
	}
	{
		...
		if in.DraftScoutingProfileMap == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v290First := true
			for v290Name, v290Value := range in.DraftScoutingProfileMap {
				if v290First {
					v290First = false
				} else {
					out.RawByte(',')
				...
				out.RawByte(':')
				easyjson83226b63EncodeGithubComCalebRoseSimFBAModels2(out, v290Value)
			}
			out.RawByte('}')
		}
	}
	...
	for !in.IsDelim('}') {
		...
		case "DraftPicks":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v291 structs.NFLDraftPick
					easyjson83226b63DecodeGithubComCalebRoseSimFBAStructs10(in, &v291)
					out.DraftPicks = append(out.DraftPicks, v291)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "ScoutProfiles":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v292 models.ScoutingProfile
					easyjson83226b63DecodeGithubComCalebRoseSimFBAModels2(in, &v292)
					out.ScoutProfiles = append(out.ScoutProfiles, v292)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson83226b63EncodeGithubComCalebRoseSimFBAModels1(out *jwriter.Writer, in models.NFLWarRoom) {
	...
	}
	{
		...
		if in.DraftPicks == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v293, v294 := range in.DraftPicks {
				if v293 > 0 {
					out.RawByte(',')
				}
				easyjson83226b63EncodeGithubComCalebRoseSimFBAStructs10(out, v294)
			}
			out.RawByte(']')
		}
	}
	{
		...
		if in.ScoutProfiles == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v295, v296 := range in.ScoutProfiles {
				if v295 > 0 {
					out.RawByte(',')
				}
				easyjson83226b63EncodeGithubComCalebRoseSimFBAModels2(out, v296)
			}
			out.RawByte(']')
		}
	}
