...
func easyjson83226b63EncodeGithubComCalebRoseSimFBAManagers13(out *jwriter.Writer, in BootstrapDataDraft) {
	...
	_ = first
	{
		...
		if in.NFLDraftees == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v289, v290 := range in.NFLDraftees {
				if v289 > 0 {
					out.RawByte(',')
				}
				easyjson83226b63EncodeGithubComCalebRoseSimFBAModels(out, v290)
			}
			out.RawByte(']')
		}
	}
	{
		...
		if in.NFLWarRoomMap == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v291First := true
			for v291Name, v291Value := range in.NFLWarRoomMap {
				if v291First {
					v291First = false
				} else {
					out.RawByte(',')
				...
				out.RawByte(':')
				easyjson83226b63EncodeGithubComCalebRoseSimFBAModels1(out, v291Value)
			}
			out.RawByte('}')
		}
	}
	{
		...
		if in.DraftScoutingProfileMap == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v292First := true
			for v292Name, v292Value := range in.DraftScoutingProfileMap {
				if v292First {
					v292First = false
				} else {
					out.RawByte(',')
				...
				out.RawByte(':')
				if v292Value == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
					out.RawString("null")
				} else {
					out.RawByte('[')
					for v293, v294 := range v292Value {
						if v293 > 0 {
							out.RawByte(',')
						}
						easyjson83226b63EncodeGithubComCalebRoseSimFBAModels2(out, v294)
					}
					out.RawByte(']')
				}
			}
	...
	}
	{
		...
		if in.NFLGameplanMap == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v295First := true
			for v295Name, v295Value := range in.NFLGameplanMap {
				if v295First {
					v295First = false
				} else {
					out.RawByte(',')
				...
				out.RawByte(':')
				easyjson83226b63EncodeGithubComCalebRoseSimFBAStructs14(out, v295Value)
			}
			out.RawByte('}')
		}
	}
	...
	for !in.IsDelim('}') {
		...
		case "DraftPicks":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v296 structs.NFLDraftPick
					easyjson83226b63DecodeGithubComCalebRoseSimFBAStructs10(in, &v296)
					out.DraftPicks = append(out.DraftPicks, v296)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "ScoutProfiles":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v297 models.ScoutingProfile
					easyjson83226b63DecodeGithubComCalebRoseSimFBAModels2(in, &v297)
					out.ScoutProfiles = append(out.ScoutProfiles, v297)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson83226b63EncodeGithubComCalebRoseSimFBAModels1(out *jwriter.Writer, in models.NFLWarRoom) {
	...
	}
	{
		...
		if in.DraftPicks == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v298, v299 := range in.DraftPicks {
				if v298 > 0 {
					out.RawByte(',')
				}
				easyjson83226b63EncodeGithubComCalebRoseSimFBAStructs10(out, v299)
			}
			out.RawByte(']')
		}
	}
	{
		...
		if in.ScoutProfiles == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v300, v301 := range in.ScoutProfiles {
				if v300 > 0 {
					out.RawByte(',')
				}
				easyjson83226b63EncodeGithubComCalebRoseSimFBAModels2(out, v301)
			}
			out.RawByte(']')
		}
	}
